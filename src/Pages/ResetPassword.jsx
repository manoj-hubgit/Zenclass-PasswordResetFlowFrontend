            ...
            <div className="bg-white p-3 rounded w-50">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="password" className="form-control rounded-0" placeholder="Enter Your New Password" id="password" onChange={(e) => setPassword(e.target.value)} required />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="confirmPassword"><strong>Confirm Password</strong></label>
                        <input type="password" className="form-control rounded-0" placeholder="Confirm Your New Password" id="confirmPassword" onChange={(e) => setConfirmPassword(e.target.value)} required />
                    </div>
